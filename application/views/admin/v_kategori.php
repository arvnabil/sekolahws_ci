...
<head>
  ...
  <title>SMK Walisongo | Kategori Berita</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Admin -->
        <?php if ($c['pengguna_level'] != 1) {} else { ?>
        <li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://iltekkomputer.com">Iltekkomputer</a>.</strong> All rights reserved.
  </footer>
