        ...
        <div class="container">       
          <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
              ...
              <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>Siswa</p>
            </div>  
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              ...
              <a href="<?php echo base_url().'assets/images/'.$row->siswa_photo;?>" class="img-gal" value="<?php echo $row->siswa_nama;?>">
                <div class="single-imgs relative">    
                  ...
                  <div class="relative">        
                    ...
                    <?php else:?>
                      <img class="img-fluid" src="<?php echo base_url().'assets/images/'.$row->siswa_photo;?>" alt="">      
                    <?php endif;?> 
                  </div>
                </div>
                <p class="text-center mt-3"><span><?php echo $row->siswa_nama;?></span>
                <br> <?php echo $row->kelas_nama;?></p>
              </a>
            </div>
            <?php endforeach;?>
          </div>
